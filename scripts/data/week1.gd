...
const DAYS := [
	{
		...
		"steps": [
			...
			{"t": "report"},
			{"t": "evening"},
			{"t": "say", "who": "narr", "text": "원룸 문 앞에 집주인의 쪽지가 붙어 있었다. '밀린 월세 48,000원. 약속대로 매주 금요일마다 12,000원씩.'"},
	...
	},
	{
		...
		"crates": [
			{"key": "pidgey1", "id": 16, "name": "구구", "memo": "1번 도로에서 그물로 잡았다.", "risk": 10},
	...
	},
	{
		...
		"crates": [
			{"key": "magikarp", "id": 129, "name": "잉어킹", "memo": "갈색시티 항구에서 건졌다. 튀어 오르기만 한다.", "risk": 10},
			{"key": "cubone", "id": 104, "name": "탕구리", "memo": "보라타운 외곽에서 혼자 울고 있던 것을 데려왔다.", "item": "뼈로 된 투구를 쓰고 있다. 벗기려고 하면 몹시 날뛴다.", "risk": 15, "named": true, "stray": 15},
	...
	},
	{
		...
		"crates": [
			...
			{"key": "bulbasaur", "id": 1, "name": "이상해씨", "memo": "태초마을 오박사 연구소 뒷마당에서 데려왔다.", "item": "등에 '오박사 연구소 관리 번호 001' 스티커가 붙어 있다.", "risk": 30, "named": true, "bonus": 2000,
				"intro": [
			...
			{"key": "slowpoke", "id": 79, "name": "야돈", "memo": "갈색시티 우물가에서 데려왔다. 잡혀 온 줄도 모르는 눈치다.", "risk": 10},
			{"key": "meowth_stray", "id": 52, "name": "나옹", "memo": "무지개시티 골목의 떠돌이.", "item": "아침에 선배네 나옹이 이 상자 앞에 한참 서 있다가 갔다.", "risk": 15, "named": true, "stray": 4},
		],
		"steps": [
